...
namespace server.Migrations
{
    ...
    [Migration("20230611140851_AccountJobEntryRelationship")]
    partial class AccountJobEntryRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("server.Models.ApplicationUserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("server.Models.Account", b =>
                {
                    b.HasOne("server.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Account")
                        .HasForeignKey("server.Models.Account", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
